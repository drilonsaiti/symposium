...
@section('content')
    <div class="min-h-screen bg-gray-50">
        <div class="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:py-16">
            ...
            {{-- Real tabs: only the selected panel is visible --}}
            <section
                                ...
                                @if($cfpIsOpen)
                                    @if($availableTalks->isNotEmpty())
                                        ...
                                        >
                                            ...
                                            <label for="talk-submission-url" class="block text-sm font-semibold text-gray-900">
                                                Choose your talk
                                            </label>
                                            ...
                                            <div class="mt-3 flex flex-col gap-3 sm:flex-row">
                                                <select
                                                    ...
                                                    required
                                                    class="min-w-0 flex-1 rounded-xl border-gray-300 bg-white text-sm text-gray-900 shadow-sm focus:border-gray-500 focus:ring-gray-500"
                                                >
                                                    <option value="">Select a talk</option>
                                                    @foreach($availableTalks as $talk)
                                                        <option value="{{ route('conferences.talks.submit', [$conference, $talk]) }}">
                                                            {{ $talk->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <button
                                                    type="submit"
                                                    class="shrink-0 rounded-xl bg-gray-950 px-5 py-3 text-sm font-semibold text-white transition hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                                                >
                                                    Submit talk
                                                </button>
                                            </div>
