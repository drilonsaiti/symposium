...
@section('content')
    <section class="relative overflow-hidden bg-white">
        ...
        <div class="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
            <div class="grid items-center gap-14 lg:grid-cols-[1.02fr_0.98fr] lg:gap-16">
                <div class="max-w-3xl">
                    <div
                        class="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3.5 py-2 text-xs font-semibold text-gray-700 shadow-sm">
                ...
                <div class="relative lg:pl-4">
                    ...
                    <div
                        class="relative overflow-hidden rounded-[2rem] border border-gray-200 bg-white shadow-2xl shadow-gray-950/10">
                        <div class="flex items-center justify-between border-b border-gray-200 bg-gray-50 px-5 py-4">
                            ...
                            <div
                                class="rounded-lg border border-gray-200 bg-white px-4 py-1.5 text-xs font-medium text-gray-500 shadow-sm">
                        ...
                        <div class="grid min-h-[510px] grid-cols-[76px_1fr] sm:grid-cols-[180px_1fr]">
                            ...
                            <div class="min-w-0 p-4 sm:p-6">
                                <div class="flex items-end justify-between gap-4">
                                    ...
                                    <span
                                        class="hidden rounded-lg bg-gray-950 px-3 py-2 text-xs font-semibold text-white sm:inline-flex">
                                    Create talk
                                </span>
                                </div>
                                ...
                                <div class="mt-6 space-y-4">
                                    <article class="rounded-2xl border border-gray-200 p-4 shadow-sm sm:p-5">
                                        <div class="flex items-start justify-between gap-3">
                                            ...
                                            <span
                                                class="rounded-lg border border-gray-200 px-2.5 py-1.5 text-[10px] font-semibold text-gray-600">
                                            Edit
                                        </span>
                                        </div>
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2">
                                        ...
                                        <article class="rounded-2xl border border-gray-200 bg-gray-950 p-4 text-white">
                                            <div class="flex items-center justify-between gap-3">
                                                ...
                                                <span
                                                    class="rounded-full bg-amber-400/15 px-2 py-1 text-[10px] font-semibold text-amber-300">
                                                Under review
                                            </span>
                                            </div>
                                    ...
                                    <div class="rounded-2xl border border-gray-200 p-4">
                                        ...
                                        <div class="mt-4 flex items-center">
                                            <span
                                                class="h-3 w-3 rounded-full bg-emerald-500 ring-4 ring-emerald-50"></span>
            ...
            <div class="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                ...
                <article class="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm xl:col-span-2">
                    <div class="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                        <div>
                            <div
                                class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gray-100 text-gray-700">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="none"
            ...
            <div class="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
                ...
                <ol class="relative space-y-5">
                    ...
                    <li class="relative rounded-3xl border border-gray-200 bg-gray-50 p-6 sm:p-7">
                        ...
                        <span
                            class="relative z-10 flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gray-950 text-sm font-bold text-white shadow-sm">
                            01
                        </span>
                    ...
                    <li class="relative rounded-3xl border border-gray-200 bg-gray-50 p-6 sm:p-7">
                        <div class="flex gap-5">
                        <span
                            class="relative z-10 flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-white text-sm font-bold text-gray-950 shadow-sm ring-1 ring-gray-200">
                            02
                        </span>
                ...
                <div class="grid lg:grid-cols-[0.9fr_1.1fr]">
                    <div class="p-8 text-white sm:p-12 lg:p-14">
                        ...
                        <div class="mt-9 space-y-4">
                            ...
                            <span
                                class="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/10">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="none"
    ...
    <section class="border-t border-gray-200 bg-white py-20 sm:py-24">
        <div class="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
            <div
                class="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gray-950 text-lg font-bold text-white shadow-sm">
                S
            </div>
